package com.crud.vuelo.service.test;
...
import com.crud.vuelo.before.repository.ClienteRepository;
import com.crud.vuelo.before.service.impl.ClienteServiceImpl;
...
public class ClienteServiceTests {
	...
	@BeforeEach
	void setup() {
		cliente = Cliente.builder().id(123).nombre("Christian").telefono("Ramirez").email("c1@gmail.com").build();
	}
	...
	void testSaveCliente_WhenDoesNotExist() {
		...
		// Arrange
		Cliente nuevo = Cliente.builder().id(1).nombre("Juan").email("juan@test.com").build();
	...
	void testListarEmpleados() {
		Cliente cliente1 = Cliente.builder().id(2).nombre("Julian").telefono("78484").email("jul@gmail.com").build();
	...
	void testActualizarCliente() {
		...
		// Arrange
		Cliente clienteExistente = Cliente.builder().id(85).nombre("Old Name").email("old@gmail.com").telefono("0000")
				.build();
